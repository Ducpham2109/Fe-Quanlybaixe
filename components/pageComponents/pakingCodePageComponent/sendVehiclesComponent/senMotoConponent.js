...
const SendMotoComponent = () => {
  ...
  return (
    ...
    <Row justify="center">
      <Col span={23}>
            <H8Styled style={{ margin:'20px 0px 20px 0px', textAlign:'center' }}>Cho xe máy vào</H8Styled>
        <Row gutter={[16,16]}>
          ...
          <StyledCol xs={24} sm={12} lg={12} style={{ marginTop: '5px', textAlign: 'center' }}>
            ...
            <Row style={{marginTop:'20px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                 {capturedImage && <img src={capturedImage} alt="Ảnh chụp"  style={{ maxWidth: '100%', maxHeight: '100%' }}/>}
            </Row>
          </StyledCol>
        </Row>       
      </Col>
      ...
      <Col span={20} style={{ marginLeft: '18px' }}>
        <Row>
        <Col xs={24} sm={12} lg={12} style={{ marginTop: '5px', textAlign: 'center' }}>
