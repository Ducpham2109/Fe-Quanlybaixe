...
import { StyledBillLisen, StyledButtonPressedEffect, StyledH2Hepl } from "../../../styled/styledListOfDevice/styledComponent";
import { useAtom } from "jotai";
import { dataParkingAtom, modalbillVisible, parkingModalData, vehicleBillModalData } from "../../../atom/store";
import { BorderBillStyded, BorderBillStyled } from "../../../styled/HomeStyledComponent/listStyled";
...
useEffect(() => {
  if (parkingCode&&vehicleyType &&username&&lisenseVehicle &&imageIn&&entryTime&&outTime) {
    form.setFieldsValue({ parkingCode,vehicleyType,parkingAddress,cost ,username,lisenseVehicle ,imageIn,entryTime, outTime });
  }
    ...
    return (
      <>
       ...
       form={form}
         ...
         >
           <h2 style={{ fontSize: '30px', textAlign: 'center' }}>Phiếu thanh toán</h2>
             <Form.Item
          name="lisenseVehicle"
