...
import { modalCostVehicle, modalbillVisible, vehicleModalData } from "../../../atom/store"
...
const FormOutVehilce = () => {
    ...
    const [outTime, setOutTime] = useState(moment().format('HH:mm:ss  YYYY-MM-DD '));
  ...
  useEffect(() => {
    if (parkingCode&&lisenseVehicle) {
      form.setFieldsValue({ parkingCode,imageOut,lisenseVehicle,username,vehicleyType,entryTime,imageIn, outTime});
    }
